...
function OpenClothingMenu()
    ...
    for v, k in pairsByKeys(Config.MenuElements) do
        ...
        table.insert(elements, {
            ...
            value = v,
            category = v,
            desc = "Changer de composant"
        })
    end

    table.insert(elements, {
        label = Config.Label["save"] or "Sauvegarder",
        value = "save",
        desc = "Sauvegarder les vêtements"
    })
...
local elements_outfits_manage = {{
    label = "Mettre la tenue",
    value = "SetOutfits",
    desc = "Mettre la tenue"
}, {
    label = "Supprimer la tenue",
    value = "DeleteOutfit",
    desc = "Supprimer la tenue"
}}
